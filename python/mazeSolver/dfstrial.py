...
# directions of surrounding nodes for DFS
...
def dfs(s, e):
    ...
    # looping until stack is not empty
    while len(stack) > 0:
        # popping one element from stack and storing in p
        p = stack.pop()
...
# Preventing DFS function to run until both clicks are performed and the starting and ending point are stored
