...
if __name__ == "__main__":
    ...
    imgProc.rotate_original_img(-2)
    imgProc.crop_original_img(105, 1815, 480, 2200)
    cv.imwrite(Path.joinpath(Path(__file__).parent.resolve(
).parent.resolve(), 'img', 'capture_cropped.jpg').__str__(), imgProc.get_original_img_array())
    # imgProc.rotate_original_img(-2.25)
    # imgProc.crop_original_img(75, 2000, 1501, 3466)
